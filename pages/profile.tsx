                    ...
                    >
                        <Grid item xs={6} sx={{ px: 1 }} >
                            <Box
                                ...
                                chartColor="blue"
                                Passed={
                                // minimumTradingDays.Reached ? 'Passed' : 
                                'In Progress'}
                            />
                        </Grid>
                        <Grid item xs={6} sx={{ px: 1 }} >
                            <Box
                                ...
                                title={" Profit Target "}
                                expectation={["Minimum: ",
                                //  profitTarget.MinimumProfit
                                ]}
                                Result={["Current result: ",
                                //  profitTarget.CurrentResult
                                ]}
                                Percent={
                                Math.max(
                                    // (+profitTarget.CurrentResult / +profitTarget.MinimumProfit) * 100,
                                    0)
                                }
                                chartColor="blue"
                                Passed={
                                // profitTarget.Reached ? 'Passed' : 
                                'In Progress'}
                            />
                        </Grid>
                        <Grid item xs={6} sx={{ px: 1 }} >
                            <Box
                                ...
                                title={" Daily Loss "}
                                expectation={["Max. loss: ", 
                                // dailyLoss.MaxDailyLoss
                            ]}
                                Result={["Max. loss recorded: ", 
                                // dailyLoss.CurrentResult
                            ]}
                                Percent={Math.max(
                                // (+dailyLoss.CurrentResult / +dailyLoss.MaxDailyLoss) * 100,
                                0)}
                                Passed={
                                // dailyLoss.Reached ? 'Failed' :
                                'Clear'}
                                chartColor="blue"
                            />
                        </Grid>
                        <Grid item xs={6} sx={{ px: 1 }} >
                            <Box
                                ...
                                Passed={
                                // initialDepositLoss.Reached ? 'Failed' :
                                'Clear'}
                                chartColor="blue"
                            />
                        </Grid>
